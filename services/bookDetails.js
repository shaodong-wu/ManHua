 ...
 */
const getComicInfoBody = (comic_id) => new Promise((resolve, reject) => {
  wx.request({
 ...
 * @param {Number} comic_id 漫画_ID
 */
const getComicInfoRole = (comic_id) => new Promise((resolve, reject) => {
  wx.request({
 ...
 * @param {Number} comic_id 漫画_ID
 */
const getComicInfoInfluence = (comic_id) => new Promise((resolve, reject) => {
  wx.request({
